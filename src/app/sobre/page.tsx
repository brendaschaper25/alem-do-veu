  ...
  return (
    <div style={{ paddingTop: '7rem', paddingBottom: '6rem', minHeight: '100vh' }}>
      <div style={{ maxWidth: '680px', margin: '0 auto', padding: '0 2rem', textAlign: 'center' }}>
        ...
        <p style={{ fontFamily: "'Lato', sans-serif", fontSize: '0.52rem', fontWeight: 300, letterSpacing: '0.38em', color: '#C9A84C', textTransform: 'uppercase', marginBottom: '1rem' }}>
          Além do Véu
        </p>

        <h1 style={{ fontFamily: "'Bodoni Moda', Georgia, serif", fontSize: 'clamp(1.7rem, 4vw, 2.6rem)', fontWeight: 700, color: '#1E1510', letterSpacing: '0.04em', lineHeight: 1.2, marginBottom: '1.5rem' }}>
        ...
        <div style={{ textAlign: 'left', fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: '1.1rem', fontWeight: 300, color: '#7A6355', lineHeight: 1.9 }}>
        ...
        <p style={{ fontFamily: "'Great Vibes', cursive", fontSize: '1.7rem', color: '#C9A84C', margin: '3rem 0 2.5rem' }}>
