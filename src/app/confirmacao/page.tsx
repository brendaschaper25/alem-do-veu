...
function ConfirmacaoContent() {
  ...
  return (
    <div style={{ paddingTop: '108px', paddingBottom: '5rem', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ maxWidth: '560px', width: '100%', padding: '0 2rem', textAlign: 'center' }}>
        ...
        {tipo === 'pix' && (
          <div style={{ background: '#FFFFFF', border: '1px solid rgba(180,160,140,0.2)', padding: '2rem', marginBottom: '2rem' }}>
            ...
            <p style={{ fontFamily: 'var(--font-lato), system-ui, sans-serif', fontSize: '0.52rem', fontWeight: 300, letterSpacing: '0.22em', color: '#A89487', textTransform: 'uppercase', marginBottom: '0.75rem' }}>
              Pix Copia e Cola
            </p>
        ...
        {tipo === 'cartao' && status !== 'pendente' && (
          <div style={{ background: '#FFFFFF', border: '1px solid rgba(180,160,140,0.2)', padding: '2rem', marginBottom: '2rem' }}>
            ...
            {Number(parcelas) > 1 && (
              <p style={{ fontFamily: 'var(--font-cormorant), Georgia, serif', fontWeight: 300, fontSize: '0.95rem', color: '#7A6355', marginBottom: '1rem' }}>
        ...
        {tipo === 'cartao' && status === 'pendente' && (
          <div style={{ background: '#FFFFFF', border: '1px solid rgba(180,160,140,0.2)', padding: '2rem', marginBottom: '2rem' }}>
            ...
            <p style={{ fontFamily: 'var(--font-cormorant), Georgia, serif', fontWeight: 300, fontSize: '1rem', color: '#7A6355', lineHeight: 1.8 }}>
