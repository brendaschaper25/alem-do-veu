      ...
      <div style={{ maxWidth: '560px', width: '100%', padding: '0 2rem', textAlign: 'center' }}>
        ...
        {tipo === 'pix' && (
          <div style={{ background: 'rgba(61,36,100,0.4)', border: '1px solid rgba(201,168,76,0.2)', padding: '2rem', marginBottom: '2rem' }}>
            ...
            <div style={{ fontSize: '0.8rem', color: '#C4B5D9', lineHeight: 1.8, marginTop: '1.5rem', textAlign: 'left' }}>
        ...
        {tipo === 'cartao' && status !== 'pendente' && (
          <div style={{ background: 'rgba(61,36,100,0.4)', border: '1px solid rgba(201,168,76,0.2)', padding: '2rem', marginBottom: '2rem' }}>
            <p style={{ fontFamily: 'Cinzel, serif', fontSize: '0.6rem', letterSpacing: '0.3em', color: '#C9A84C', textTransform: 'uppercase', marginBottom: '0.5rem' }}>Pagamento aprovado</p>
            <p style={{ fontFamily: 'Cinzel, serif', fontSize: '2rem', color: '#F0EAFF', marginBottom: '0.5rem' }}>
              {totalFormatado}
            </p>
            {Number(parcelas) > 1 && (
              <p style={{ fontSize: '0.8rem', color: '#C4B5D9', marginBottom: '1rem' }}>
                em {parcelas}x no cartão de crédito
              </p>
            )}
            <div style={{ background: 'rgba(201,168,76,0.1)', border: '1px solid rgba(201,168,76,0.2)', padding: '1rem', marginTop: '1rem' }}>
              <p style={{ fontSize: '0.8rem', color: '#C4B5D9', lineHeight: 1.8 }}>
        ...
        {tipo === 'cartao' && status === 'pendente' && (
          <div style={{ background: 'rgba(61,36,100,0.4)', border: '1px solid rgba(201,168,76,0.2)', padding: '2rem', marginBottom: '2rem' }}>
            <p style={{ fontFamily: 'Cinzel, serif', fontSize: '0.6rem', letterSpacing: '0.3em', color: '#C9A84C', textTransform: 'uppercase', marginBottom: '0.5rem' }}>Aguardando confirmação</p>
            <p style={{ fontFamily: 'Cinzel, serif', fontSize: '2rem', color: '#F0EAFF', marginBottom: '1rem' }}>
              {totalFormatado}
            </p>
            <p style={{ fontSize: '0.8rem', color: '#C4B5D9', lineHeight: 1.8 }}>
